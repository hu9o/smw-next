...
void Menu::CreateMenu()
{
    ...
    */
    ...
    miTeamSelectHeaderText = new MI_Text("Team and Character Selection - test", 320, 5, 0, 2, 1);
    ...
    miPowerupSettingsMenuRightHeaderBar = new MI_Image(&rm->menu_plain_field, smw->ScreenWidth/2, 0, 192, 0, 320, 32, 1, 1, 0);
    miPowerupSettingsMenuHeaderText = new MI_Text("Item Settings Menu", smw->ScreenWidth/2, 5, 0, 2, 1);
